        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_WatchLists_WatchListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchListByFilms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WatchListByFilms_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WatchListByFilms_WatchLists_WatchListId",
                        column: x => x.WatchListId,
                        principalTable: "WatchLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchListByFilms_FilmId",
                table: "WatchListByFilms",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchListByFilms_WatchListId",
                table: "WatchListByFilms",
                column: "WatchListId");
        }
